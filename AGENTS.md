# TurboXml — Codex Agent Instructions

TurboXml is a .NET library that provides a lightweight and fast SAX - Simple API XML parserby using callbacks.

Paths/commands below are relative to this directory.

## Orientation

- Library: `src/TurboXml/`
- Tests: `src/TurboXml.Tests/` (MSTest)
- CodeGen: `src/TurboXml.CodeGen/` (source generator to quickly classify a unicode character)
